...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="configmap" tabindex="-1"><a class="header-anchor" href="#configmap"><span>ConfigMap</span></a></h2><p>抽取应用配置，并且可以自动更新</p>`,37),I={href:"https://kubernetes.io/zh-cn/docs/concepts/configuration/configmap/",target:"_blank",rel:"noopener noreferrer"},G=t(`<p><strong>以 redis 示例</strong></p><h3 id="_1、把之前的配置文件创建为配置集" tabindex="-1"><a class="header-anchor" href="#_1、把之前的配置文件创建为配置集"><span>1、把之前的配置文件创建为配置集</span></a></h3><p>创建配置，redis保存到k8s的etcd；</p><p>语法：kubectl create configmap [NAME] [DATA]</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kubectl create configmap redis-conf --from-file<span class="token operator">=</span>redis.conf
