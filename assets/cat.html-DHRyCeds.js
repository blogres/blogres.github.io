import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as e,o as t,c as i,b as n,d as l,w as c,a as p,e as o}from"./app-DXPUtFHE.js";const d={},r=n("h3",{id:"cat-显示较少内容",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#cat-显示较少内容"},[n("span",null,"cat 显示较少内容")])],-1),u=p(`<p>①、命令名称：</p><p>②、英文原意：</p><p>③、命令所在路径：</p><p>④、执行权限：所有用户</p><p>⑤、功能描述：在 Linux 系统下使用 cat 命令进行多个小文件的合并也很方便</p><p>⑥、语法：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">cat</span> <span class="token punctuation">[</span>选项<span class="token punctuation">]</span> <span class="token punctuation">[</span>文件名<span class="token punctuation">]</span>
