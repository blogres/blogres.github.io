import{_ as e}from"./true-image-20220913170020223-Bz1Za6jR.js";import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as a,o as l,c as t,b as n,d as o,w as d,a as r,e as c}from"./app-DXPUtFHE.js";const m={},p=n("h3",{id:"sort-排序数据",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#sort-排序数据"},[n("span",null,"sort 排序数据")])],-1),u=r('<p>①、命令名称：sort</p><p>②、英文原意：</p><p>③、命令所在路径：</p><p>④、执行权限：所有用户</p><p>⑤、功能描述：对数据进行排序</p><p>⑥、语法：</p><p>cat 【选项】 【文件】</p><figure><img src="'+e+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@admin home<span class="token punctuation">]</span><span class="token comment"># cat demo.txt</span>
one
two
three
four
