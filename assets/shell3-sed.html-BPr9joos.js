import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as e,a}from"./app-DXPUtFHE.js";const i="/assets/true-image-20220919164800283-B9oTRkxO.png",l={},t=a(`<p>shell脚本高级实战案例篇之Sed</p><h1 id="shell脚本编程-高级篇之sed" tabindex="-1"><a class="header-anchor" href="#shell脚本编程-高级篇之sed"><span>Shell脚本编程-高级篇之sed</span></a></h1><h2 id="sed" tabindex="-1"><a class="header-anchor" href="#sed"><span>sed</span></a></h2><h3 id="基础" tabindex="-1"><a class="header-anchor" href="#基础"><span>基础</span></a></h3><p>sed编辑器被称作流编辑器（stream editor），和普通的交互式文本编辑器恰好相反。在交互式文本编辑器中（比如vim），你可以用键盘命令来交互式地插入、删除或替换数据中的文本。</p><p>sed编辑器会执行下列操作:</p><ul><li>(1) 一次从输入中读取一行数据。</li><li>(2) 根据所提供的编辑器命令匹配数据。</li><li>(3) 按照命令修改流中的数据。</li><li>(4) 将新的数据输出到 STDOUT 。</li></ul><p>语法格式：</p><blockquote><p>sed options script file</p></blockquote><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>选 项    描 述
